package com.psrestassured.bodyvalidation;
...
public class _4BasicResponseBody {
    ...
    public void jsonPathReturnsMap(){
        ...
        Map<String, String> subMap2 = jPath2.getMap("resources.core");
    ...
    public void castingFailure(){
        JsonPath jPath = RestAssured.get(BASE_URL).getBody().jsonPath();

        Map<String, String> isNull = jPath.get("incorrect.path"); //NPE
        int aMap = jPath.get("resources.core");                     //Class cast exception
        String value = jPath.get("resources.core.limit");           //Class cast exception
